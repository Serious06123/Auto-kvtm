...
const sellItems = async (driver, mutex, mutex2, removeItems = false, quantity = 0) => {
  // Sell Goods
  await core.sellItems(driver, SellItemOptions.goods, [{ key: ProductKeys['p-buom'], value: 8 }, { key: ProductKeys['p-ong'], value: 8 }, { key: ProductKeys['p-chuon-chuon'], value: 7 }], mutex, mutex2, removeItems, true, false)
}
